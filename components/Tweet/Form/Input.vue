...
const handleFormSubmit = () => {
	emits("onSubmit", {
		text: text.value,
		mediaFiles: selectFile.value ? [selectFile.value] : undefined,
	});
	text.value = "";
};
...
<template>
	<div>
		<div flex="~ shrink-0" items-center p4 pb0>
			<div flex w12 items-start>
				<img
		...
		<div flex p2 pl14>
			<div flex w-full text-white>
				...
				>
					<svg viewBox="0 0 24 24" w5 h5 fill="currentColor">
						<g>
							<path
			...
			<div ml-auto>
				<UIButton size="sm"> <span font-bold>Tweet</span> </UIButton>
			</div>
		</div>
	</div>
</template>
